...
git clone https://github.com/ghkdtnsejr6/factor.git
cd factor
...
```bash
    ...
    From https://github.com/ghkdtnsejr6/factor
...
[factor/gitian.sigs](https://github.com/ghkdtnsejr6/gitian.sigs/) repository, or if that's not possible to create a pull
request.
